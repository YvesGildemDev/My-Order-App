const STARTERS = [
  {
    ...
    price: 4.9,
    desc: "Knackiger Mix aus Blattsalaten, Tomaten, Gurken und Karotten, serviert mit leichter Zitronen-Vinaigrette. Erfrischend und perfekt als leichter Start ins Menü.",
  },
  {
    name: "Gurkensalat in Sesam-Dressing",
    price: 3.9,
    desc: "Dünn geschnittene Gurkenscheiben in einem milden Sesam-Reisessig-Dressing mit geröstetem Sesam. Kühl, aromatisch und besonders beliebt zu asiatischen Gerichten.",
  },
  {
    name: "Wakame-Algensalat",
    price: 5.5,
    desc: "Marinierter japanischer Algensalat mit leicht süß-saurer Note, Sesam und feiner Chiliwürzung. Perfekt als traditionelle Vorspeise oder Beilage.",
  },
  {
    name: "Mini-Frühlingsrollen (6 Stück)",
    price: 4.5,
    desc: "Knusprige Mini-Frühlingsrollen mit Gemüsefüllung, serviert mit süß-saurer Sauce. Perfekt zum Teilen oder als Snack für zwischendurch.",
  },
  {
    name: "Miso-Suppe",
    price: 3.5,
    desc: "Klassische japanische Suppe mit Miso-Paste, Tofu, Wakame und Frühlingszwiebeln. Warm, herzhaft und ideal als leichter Einstieg.",
  },
  {
    name: "Saté-Erdnusssauce",
    price: 2.9,
    desc: "Cremige, hausgemachte Erdnusssauce mit feiner Kokosnote. Perfekt als Dip zu Vorspeisen oder als Zusatz zu Hauptgerichten.",
  },
];
