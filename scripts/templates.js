...
switch (group) {
case "starter": menuGroup = STARTERS; break;
case "maindishes": menuGroup = MAINDISHES; break;
case "desserts": menuGroup = DESSERTS; break;
}


document.querySelectorAll(".menu_tab").forEach(t => t.classList.remove("active"));
